...
<div
        ...
        class="relative inline-block -top-3">
    ...
    <div x-ref="content" class="px-3 py-1 text-xs rounded-full cursor-pointer text-neutral-500 bg-transparent hover:bg-neutral-100">?</div>
