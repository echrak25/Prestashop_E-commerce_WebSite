...
<div x-data="{
    ...
    {if !empty($xmodel)}
        <input type="hidden" x-ref="modelInput" name="{$name|escape:'htmlall':'UTF-8'}" x-model="{$xmodel|escape:'htmlall':'UTF-8'}" x-init="{$xmodel|escape:'htmlall':'UTF-8'} = selectedItem.value" :value="selectedItem.value">
    {else}
