...
class PostGenerateBulkCategoriesContentWithSubCategoriesCommand implements CommandInterface
{
    private $data;
    private $entity;
            ...
            if ($contextShopId === \Shop::CONTEXT_ALL || $contextShopId === \Shop::CONTEXT_GROUP) {
                ...
                foreach ($shops as $idShop) {
                    foreach ($categories as $id_category) {
                        ...
                        $this->addSubcategoriesToCron($id_category, $idShop, false, $this->defaultLang);
                    }
                }
            } else {
    ...
    private function addSubcategoriesToCron($id_category, $idShop, $only_empty, $defaultIdLang)
    {
        ...
        foreach ($subCategories as $subCategory) {
            ...
            $this->addToList($entityId, $idShop);
