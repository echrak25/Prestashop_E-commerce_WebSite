...
*}
{if $reviews}
    <div class="ets-ttn-home-reviews" {if $ETS_TTN_BACKGROUND} style="background-image: url('{$link->getMediaLink("`$smarty.const.__PS_BASE_URI__`img/ets_testimonial/`$ETS_TTN_BACKGROUND|escape:'html':'UTF-8'`")}')"{/if}>
