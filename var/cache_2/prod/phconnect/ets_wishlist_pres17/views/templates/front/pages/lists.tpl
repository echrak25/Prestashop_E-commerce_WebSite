                            ...
                            <td class="ets-wishlist-list-item-right">
                                ...
                                <div class="ets_wl_share_social">
                                    ...
                                    <ul class="buttons-share-wishlist" style="">
                                        ...
                                        <li class="twitter">
                                            <a class="" href="https://twitter.com/intent/tweet?text={$wishlist.name|escape:'html':'UTF-8'} {$wishlist.listUrl|escape:'html':'UTF-8'}" title="Tweet" target="_blank" rel="noopener noreferrer">
